		...
		<div class="container">
			...
			<div class="row property_gallery">
				<div class="col-lg-3 col-md-4 col-sm-6">
					<div class="product_item">
						<div class="product_item_pic">
							<img src="<?=base_url('assets/images/sports_1.jfif');?>" alt="">
				...
				<div class="col-lg-3 col-md-4 col-sm-6">
					<div class="product_item">
						<div class="product_item_pic">
							<img src="<?=base_url('assets/images/sports_2.jfif');?>" alt="">
							<div class="label">New</div>
							<ul class="product_hover">
								<li><a href="#"><i class="fas fa-arrows-alt"></i></a></li>
								<li><a href="#"><i class="fas fa-heart"></i></a></li>
						...
						<div class="product_item_text">
							<h6><a href="#">Sports Top Muscle Fit</a></h6>
							<div class="rating">
								<i class="fas fa-star"></i>
								<i class="fas fa-star"></i>
								<i class="fas fa-star"></i>
				...
				<div class="col-lg-3 col-md-4 col-sm-6">
					<div class="product_item">
						<div class="product_item_pic">
							<img src="<?=base_url('assets/images/sports_3.jfif');?>" alt="">
							<div class="label">New</div>
							<ul class="product_hover">
								<li><a href="#"><i class="fas fa-arrows-alt"></i></a></li>
								<li><a href="#"><i class="fas fa-heart"></i></a></li>
						...
						<div class="product_item_text">
							...
							<div class="product_price">KES 1000</div>
						</div>
					</div>
				</div>
				...
				<div class="col-lg-3 col-md-4 col-sm-6">
					<div class="product_item">
						<div class="product_item_pic">
							<img src="<?=base_url('assets/images/sports_4.jfif')?>" alt="">
							<div class="label">New</div>
							<ul class="product_hover">
								<li><a href="#"><i class="fas fa-arrows-alt"></i></a></li>
								<li><a href="#"><i class="fas fa-heart"></i></a></li>
				...
				<div class="col-lg-3 col-md-4 col-sm-6">
					<div class="product_item">
						<div class="product_item_pic">
							<img src="<?=base_url('assets/images/sports_5.jfif');?>" alt="">
							<div class="label">New</div>
							<ul class="product_hover">
								<li><a href="#"><i class="fas fa-arrows-alt"></i></a></li>
								<li><a href="#"><i class="fas fa-heart"></i></a></li>
				...
				<div class="col-lg-3 col-md-4 col-sm-6">
					<div class="product_item">
						<div class="product_item_pic">
							<img src="<?=base_url('assets/images/sports_6.jfif');?>" alt="">
							<div class="label">New</div>
							<ul class="product_hover">
								<li><a href="#"><i class="fas fa-arrows-alt"></i></a></li>
								<li><a href="#"><i class="fas fa-heart"></i></a></li>
				...
				<div class="col-lg-3 col-md-4 col-sm-6">
					<div class="product_item">
						<div class="product_item_pic">
							<img src="<?=base_url('assets/images/sports_7.jfif')?>" alt="">
							<div class="label">New</div>
							<ul class="product_hover">
								<li><a href="#"><i class="fas fa-arrows-alt"></i></a></li>
								<li><a href="#"><i class="fas fa-heart"></i></a></li>
				...
				<div class="col-lg-3 col-md-4 col-sm-6">
					<div class="product_item">
						<div class="product_item_pic">
							<img src="<?=base_url('assets/images/sports_8.jfif');?>" alt="">
							<div class="label">New</div>
							<ul class="product_hover">
								<li><a href="#"><i class="fas fa-arrows-alt"></i></a></li>
								<li><a href="#"><i class="fas fa-heart"></i></a></li>
