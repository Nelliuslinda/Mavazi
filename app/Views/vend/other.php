		...
		<div class="container">
			...
			<div class="row property_gallery">
				<div class="col-lg-3 col-md-4 col-sm-6">
					<div class="product_item">
						<div class="product_item_pic">
							<img src="<?=base_url('assets/images/other_1.jpg');?>" alt="">
						...
						<div class="product_item_text">
							<h6><a href="#">Dog Gold Necklace</a></h6>
							<div class="rating">
				...
				<div class="col-lg-3 col-md-4 col-sm-6">
					<div class="product_item">
						<div class="product_item_pic">
							<img src="<?=base_url('assets/images/other_2.jpg');?>" alt="">
							<div class="label">New</div>
							<ul class="product_hover">
								<li><a href="#"><i class="fas fa-arrows-alt"></i></a></li>
								<li><a href="#"><i class="fas fa-heart"></i></a></li>
				...
				<div class="col-lg-3 col-md-4 col-sm-6">
					<div class="product_item">
						<div class="product_item_pic">
							<img src="<?=base_url('assets/images/other_3.jpg');?>" alt="">
							<div class="label">New</div>
							<ul class="product_hover">
								<li><a href="#"><i class="fas fa-arrows-alt"></i></a></li>
								<li><a href="#"><i class="fas fa-heart"></i></a></li>
				...
				<div class="col-lg-3 col-md-4 col-sm-6">
					<div class="product_item">
						<div class="product_item_pic">
							<img src="<?=base_url('assets/images/other_4.jpg');?>" alt="">
							<div class="label">New</div>
							<ul class="product_hover">
								<li><a href="#"><i class="fas fa-arrows-alt"></i></a></li>
								<li><a href="#"><i class="fas fa-heart"></i></a></li>
