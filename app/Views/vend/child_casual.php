		...
		<div class="container">
			<div class="row">
				<div class="col-lg-12 text-center">
					<div class="section-title">
						<h4>Children Casual Collection</h4>
					</div>
				</div>
			</div>
			<div class="row property_gallery">
				<div class="col-lg-3 col-md-4 col-sm-6">
					<div class="product_item">
						<div class="product_item_pic">
							<img src="<?=base_url('assets/images/casual_17.jfif');?>" alt="">
						...
						<div class="product_item_text">
							<h6><a href="#">2-piece patterned set</a></h6>
							<div class="rating">
				...
				<div class="col-lg-3 col-md-4 col-sm-6">
					<div class="product_item">
						<div class="product_item_pic">
							<img src="<?=base_url('assets/images/casual_18.jfif');?>" alt="">
							<div class="label">New</div>
							<ul class="product_hover">
								<li><a href="#"><i class="fas fa-arrows-alt"></i></a></li>
								<li><a href="#"><i class="fas fa-heart"></i></a></li>
				...
				<div class="col-lg-3 col-md-4 col-sm-6">
					<div class="product_item">
						<div class="product_item_pic">
							<img src="<?=base_url('assets/images/casual_19.jfif');?>" alt="">
							<div class="label">New</div>
							<ul class="product_hover">
								<li><a href="#"><i class="fas fa-arrows-alt"></i></a></li>
								<li><a href="#"><i class="fas fa-heart"></i></a></li>
						...
						<div class="product_item_text">
							<h6><a href="#">Denim Dungarees</a></h6>
							<div class="rating">
								<i class="fas fa-star"></i>
								<i class="fas fa-star"></i>
								<i class="fas fa-star"></i>
				...
				<div class="col-lg-3 col-md-4 col-sm-6">
					<div class="product_item">
						<div class="product_item_pic">
							<img src="<?=base_url('assets/images/casual_20.jfif');?>" alt="">
							<div class="label">New</div>
							<ul class="product_hover">
								<li><a href="#"><i class="fas fa-arrows-alt"></i></a></li>
								<li><a href="#"><i class="fas fa-heart"></i></a></li>
						...
						<div class="product_item_text">
							<h6><a href="#">3-piece graphic tees</a></h6>
							<div class="rating">
								<i class="fas fa-star"></i>
								<i class="fas fa-star"></i>
								<i class="fas fa-star"></i>
				...
				<div class="col-lg-3 col-md-4 col-sm-6">
					<div class="product_item">
						<div class="product_item_pic">
							<img src="<?=base_url('assets/images/casual_21.jfif');?>" alt="">
							<div class="label">New</div>
							<ul class="product_hover">
								<li><a href="#"><i class="fas fa-arrows-alt"></i></a></li>
								<li><a href="#"><i class="fas fa-heart"></i></a></li>
				...
				<div class="col-lg-3 col-md-4 col-sm-6">
					<div class="product_item">
						<div class="product_item_pic">
							<img src="<?=base_url('assets/images/casual_22.jfif');?>" alt="">
							<div class="label">New</div>
							<ul class="product_hover">
								<li><a href="#"><i class="fas fa-arrows-alt"></i></a></li>
								<li><a href="#"><i class="fas fa-heart"></i></a></li>
						...
						<div class="product_item_text">
							<h6><a href="#">2-piece boy's set</a></h6>
							<div class="rating">
								<i class="fas fa-star"></i>
								<i class="fas fa-star"></i>
								<i class="fas fa-star"></i>
				...
				<div class="col-lg-3 col-md-4 col-sm-6">
					<div class="product_item">
						<div class="product_item_pic">
							<img src="<?=base_url('assets/images/casual_23.jfif');?>" alt="">
							<div class="label">New</div>
							<ul class="product_hover">
								<li><a href="#"><i class="fas fa-arrows-alt"></i></a></li>
								<li><a href="#"><i class="fas fa-heart"></i></a></li>
						...
						<div class="product_item_text">
							<h6><a href="#">2-piece girl's set</a></h6>
							<div class="rating">
								<i class="fas fa-star"></i>
								<i class="fas fa-star"></i>
								<i class="fas fa-star"></i>
							...
							<div class="product_price">KES 1900</div>
						</div>
					</div>
				</div>
				...
				<div class="col-lg-3 col-md-4 col-sm-6">
					<div class="product_item">
						<div class="product_item_pic">
							<img src="<?=base_url('assets/images/casual_24.jfif');?>" alt="">
							<div class="label">New</div>
							<ul class="product_hover">
								<li><a href="#"><i class="fas fa-arrows-alt"></i></a></li>
								<li><a href="#"><i class="fas fa-heart"></i></a></li>
						...
						<div class="product_item_text">
							<h6><a href="#">Cotton pattern shirt</a></h6>
							<div class="rating">
								<i class="fas fa-star"></i>
								<i class="fas fa-star"></i>
								<i class="fas fa-star"></i>
