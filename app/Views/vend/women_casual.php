		...
		<div class="container">
			<div class="row">
				<div class="col-lg-12 text-center">
					<div class="section-title">
						<h4>Women's Casual Collection</h4>
					</div>
				</div>
			</div>
			<div class="row property_gallery">
				<div class="col-lg-3 col-md-4 col-sm-6">
					<div class="product_item">
						<div class="product_item_pic">
							<img src="<?=base_url('assets/images/casual_9.jfif');?>" alt="">
				...
				<div class="col-lg-3 col-md-4 col-sm-6">
					<div class="product_item">
						<div class="product_item_pic">
							<img src="<?=base_url('assets/images/casual_10.jfif');?>" alt="">
							<div class="label">New</div>
							<ul class="product_hover">
								<li><a href="#"><i class="fas fa-arrows-alt"></i></a></li>
								<li><a href="#"><i class="fas fa-heart"></i></a></li>
				...
				<div class="col-lg-3 col-md-4 col-sm-6">
					<div class="product_item">
						<div class="product_item_pic">
							<img src="<?=base_url('assets/images/casual_11.jfif');?>" alt="">
							<div class="label">New</div>
							<ul class="product_hover">
								<li><a href="#"><i class="fas fa-arrows-alt"></i></a></li>
								<li><a href="#"><i class="fas fa-heart"></i></a></li>
				...
				<div class="col-lg-3 col-md-4 col-sm-6">
					<div class="product_item">
						<div class="product_item_pic">
							<img src="<?=base_url('assets/images/casual_12.jfif');?>" alt="">
							<div class="label">New</div>
							<ul class="product_hover">
								<li><a href="#"><i class="fas fa-arrows-alt"></i></a></li>
								<li><a href="#"><i class="fas fa-heart"></i></a></li>
						...
						<div class="product_item_text">
							<h6><a href="#">Oversized Leopard Print Shirt</a></h6>
							<div class="rating">
								<i class="fas fa-star"></i>
								<i class="fas fa-star"></i>
								<i class="fas fa-star"></i>
							...
							<div class="product_price">KES 1100</div>
						</div>
					</div>
				</div>
				...
				<div class="col-lg-3 col-md-4 col-sm-6">
					<div class="product_item">
						<div class="product_item_pic">
							<img src="<?=base_url('assets/images/casual_13.jfif');?>" alt="">
							<div class="label">New</div>
							<ul class="product_hover">
								<li><a href="#"><i class="fas fa-arrows-alt"></i></a></li>
								<li><a href="#"><i class="fas fa-heart"></i></a></li>
				...
				<div class="col-lg-3 col-md-4 col-sm-6">
					<div class="product_item">
						<div class="product_item_pic">
							<img src="<?=base_url('assets/images/casual_14.jfif');?>" alt="">
							<div class="label">New</div>
							<ul class="product_hover">
								<li><a href="#"><i class="fas fa-arrows-alt"></i></a></li>
								<li><a href="#"><i class="fas fa-heart"></i></a></li>
						...
						<div class="product_item_text">
							<h6><a href="#">Cropped Basketball Jacket</a></h6>
							<div class="rating">
								<i class="fas fa-star"></i>
								<i class="fas fa-star"></i>
								<i class="fas fa-star"></i>
				...
				<div class="col-lg-3 col-md-4 col-sm-6">
					<div class="product_item">
						<div class="product_item_pic">
							<img src="<?=base_url('assets/images/casual_15.jfif');?>" alt="">
							<div class="label">New</div>
							<ul class="product_hover">
								<li><a href="#"><i class="fas fa-arrows-alt"></i></a></li>
								<li><a href="#"><i class="fas fa-heart"></i></a></li>
				...
				<div class="col-lg-3 col-md-4 col-sm-6">
					<div class="product_item">
						<div class="product_item_pic">
							<img src="<?=base_url('assets/images/casual_16.jfif');?>" alt="">
							<div class="label">New</div>
							<ul class="product_hover">
								<li><a href="#"><i class="fas fa-arrows-alt"></i></a></li>
								<li><a href="#"><i class="fas fa-heart"></i></a></li>
						...
						<div class="product_item_text">
							<h6><a href="#">Straight High Jeans</a></h6>
							<div class="rating">
								<i class="fas fa-star"></i>
								<i class="fas fa-star"></i>
								<i class="fas fa-star"></i>
